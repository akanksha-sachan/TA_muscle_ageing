...
out_path <- "/ix/djishnu/Akanksha/ERCC1_snRNA_analysis/ERCC1_exp/Seurat_analysis"
...
```{r save rds}
saveRDS(condition_obj_list$KO, file = paste0(out_path, "/objects/KO_major_celltype_obj.rds"))
saveRDS(condition_obj_list$WT, file = paste0(out_path, "/objects/WT_major_celltype_obj.rds"))
```
