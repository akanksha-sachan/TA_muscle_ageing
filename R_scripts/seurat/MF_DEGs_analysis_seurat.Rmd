...
# Directories
out_path <- "/ocean/projects/cis240075p/asachan/datasets/TA_muscle/ERCC1_KO_mice/integrated_samples"
sample_names <- c('F3_WT', 'F4_WT', 'F7_KO', 'F15_WT', 'F706_KO', 'F785_KO')
```

# Load scanpy preprocessing output
``` {r H5ad to Rds}
# Read h5ad files back into Seurat objects
female_h5ad <- MuDataSeurat::ReadH5AD(file.path(out_path, "female_scANVI_v2.h5ad"))
# Save as RDS files
saveRDS(female_h5ad, file.path(out_path, "female_scANVI_v2.rds"))
```
